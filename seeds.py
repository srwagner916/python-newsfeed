...
# insert users
db.add_all([
  User(username='alesmonde0', email='nwestnedge0@cbc.ca', password='password'),
  User(username='jwilloughway1', email='rmebes1@sogou.com', password='password'),
  User(username='iboddam2', email='cstoneman2@last.fm', password='password'),
  User(username='dstanmer3', email='ihellier3@goo.ne.jp', password='password'),
  User(username='djiri4', email='gmidgley4@weather.com', password='password'),
])
